...
import bgImage from '../assets/i5.png';
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center px-6 pt-24 pb-10 md:px-24">
        ...
        >
          ...
          <p className="text-white text-sm md:text-base font-light leading-relaxed max-w-3xl">
            You can find and connect with talented music producers directly through our website.
            Whether you're looking for someone to mix your track, produce a beat, or help shape your sound,
            our platform makes it easy to discover and collaborate with the right producer for your project.
          </p>

          {/* Right Arrow */}
          <button
            onClick={() => handleNavigate('/explore5', 1)}
            className="text-white text-2xl hover:translate-x-1 transition-transform duration-300"
       ...
       <motion.div
        ...
        <Link
          to="/ai_chat_land"
          className="px-6 py-3 text-white border border-white rounded-xl font-medium hover:bg-white hover:text-black transition duration-300 mt-5"
        >
          CHAT
        </Link>
      </motion.div>
