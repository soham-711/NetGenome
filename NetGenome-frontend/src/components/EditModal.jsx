...
export function EditModal({ onBack }) {
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: "Additional",
      icon: BookOpen,
      color: "from-red-500/50 to-white-600/50",
    },
  ];
  ...
  try {
    ...
    // Prepare updates
    const { _id, _creationTime, imageFile, artistID, ...validUpdates } = formData;
    ...
    validUpdates.imageUrl = imageUrl || formData.imageUrl;

    // Clean undefined/null values
    const cleanUpdates = JSON.parse(JSON.stringify(validUpdates));
  ...
  // Helper function to render array inputs
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-lg text-white placeholder-white/60"
            placeholder="e.g., Legacy-affiliated Blues Artists"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <input
            type="number"
            name="birthYear"
            value={formData.identity.birthYear}
            onChange={(e) => handleNestedChange(e, "identity")}
            min="1900"
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          value={formData.artistic_background.signature_style}
          onChange={(e) => handleNestedChange(e, "artistic_background")}
          className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-white placeholder-white/60"
          rows={4}
          placeholder="Describe your signature style and what makes you unique..."
        />
      </div>
    </div>
  );
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          value={formData.career.career_evolution}
          onChange={(e) => handleNestedChange(e, "career")}
          className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-white placeholder-white/60"
          rows={4}
          placeholder="Describe your career journey and evolution..."
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <input
          type="text"
          name="years_active"
          value={formData.career.years_active}
          onChange={(e) => handleNestedChange(e, "career")}
          className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-white placeholder-white/60"
          placeholder="e.g., 1998-present"
        />
      </div>
  ...
  const renderCreative = () => (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <textarea
          name="creative_rituals"
          value={formData.creative_process.creative_rituals}
          onChange={(e) => handleNestedChange(e, "creative_process")}
          className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-white placeholder-white/60"
          rows={5}
          placeholder="Describe any creative rituals or habits you have when making music..."
        />
      </div>
    </div>
  );
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSocialMediaChange(e, index, "followers")
                    }
                    className="w-full px-4 py-3 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md text-white placeholder-white/60"
                    placeholder="e.g., ~2.3K followers"
                  />
                </div>
              </div>
              <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    value={item.stats}
                    onChange={(e) =>
                      handleStreamingPlatformChange(e, index, "stats")
                    }
                    className="w-full px-4 py-3 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md text-white placeholder-white/60"
                    placeholder="e.g., ~18,000 monthly listeners"
                  />
                </div>
              </div>
              <button
  ...
  const renderQuotes = () => (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          {formData.fan_press_quotes?.map((quote, index) => (
            <div key={index} className="flex items-start gap-3 group">
              <div className="flex-1 space-y-2">
                <textarea
                  value={quote}
                  onChange={(e) => handleArrayChange(e, "fan_press_quotes", index)}
                  className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-white placeholder-white/60"
                  rows={3}
                  placeholder="Enter notable quotes from fans or press about your work..."
                />
              </div>
              <button
                type="button"
                onClick={() => handleRemoveArrayItem("fan_press_quotes", index)}
                className="p-3 text-red-400 hover:text-red-300 hover:bg-red-500/20 rounded-full transition-all duration-200 opacity-0 group-hover:opacity-100 mt-1 backdrop-blur-md"
              >
                <Trash2 size={18} />
              </button>
          ...
          <button
            type="button"
            onClick={() => handleAddArrayItem("fan_press_quotes")}
            className="flex items-center gap-2 px-4 py-3 text-orange-400 hover:text-orange-300 hover:bg-orange-500/20 rounded-3xl transition-all duration-200 border-2 border-dashed border-orange-400/30 hover:border-orange-400/50 w-full justify-center backdrop-blur-md"
          >
            <Plus size={18} />
            Add Fan/Press Quote
    ...
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-white placeholder-white/60"
          rows={4}
          placeholder="Describe your merchandise, store links, or commerce information..."
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-white placeholder-white/60"
          rows={4}
          placeholder="Describe any social impact work, advocacy, or causes you support..."
        />
      </div>
      ...
      <div className="space-y-2">
        <label className=" text-sm font-bold text-white flex items-center gap-2 drop-shadow-lg">
          ...
          Long Narrative/Biography
        </label>
        <textarea
          name="long_narrative"
          value={formData.long_narrative}
          onChange={handleChange}
          className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-white placeholder-white/60"
          rows={8}
          placeholder="Enter your detailed biography or narrative..."
        />
      </div>

      <div className="space-y-2">
        <label className=" text-sm font-bold text-white flex items-center gap-2 drop-shadow-lg">
          <Bookmark className="h-5 w-5 text-red-400" />
          Lazie Indie Association
        </label>
        <input
          type="text"
          name="lazie_indie_association"
          value={formData.lazie_indie_association}
          onChange={handleChange}
          className="w-full px-4 py-4 border border-white/20 rounded-3xl focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-md shadow-lg hover:shadow-xl text-white placeholder-white/60"
          placeholder="e.g., Heritage Blues-Rock | Indie-Adjacent"
        />
      </div>
    </div>
  );
